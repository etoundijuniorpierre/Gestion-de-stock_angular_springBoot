...
export const routes: Routes = [
  ...
  { 
    ...
    children: [
      ...
      { path: 'fournisseurs', component: PageClientsComponent, title: 'Fournisseurs' },
      ...
      { path: 'commandesFournisseur', component: PageCommandesClientsComponent, title: 'CommandesFournisseur' },
      { path: 'utilisateurs', component: PageClientsComponent, title: 'Utilisateurs' },
